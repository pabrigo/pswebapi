SharrrePlatform.register("google-plus", function (options) {
    ...
    return {
        ...
        load: function (self) {
            ...
            //$(self.element).find('.buttons').append('<div class="button google-plus"><g:plusone size="'+self.options.buttons.google-plus.size+'" href="'+self.options.url+'"></g:plusone></div>');
